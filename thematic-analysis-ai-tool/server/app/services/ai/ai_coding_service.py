    ...
    def _apply_changes_to_database(
        ...
        for code_name, code_data in codes_dict.items():
            ...
            if existing_code:
                ...
                if new_group_name and existing_code.group_name != new_group_name:
                    ...
                    print(f"DEBUG: Updated group_name for code '{code_name}' to '{new_group_name}'")
        ...
        for assignment_data in assignments:
            ...
            assignment_mappings.append({
                ...
                "updated_at": datetime.datetime.now(datetime.timezone.utc)  # Add updated_at
            })
        ...
        if assignment_mappings:
            try:
                ...
                print(f"✅ Successfully bulk inserted {len(assignment_mappings)} assignments")
            except Exception as e:
